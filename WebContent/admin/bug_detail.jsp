...
<title>
${fn:substring(oneAdvice.adviceTheme, 0, 10)} 
<c:if test="${fn:length(oneAdvice.adviceTheme)>10}">...</c:if>
</title>
									...
									<div class="col-sm-12">
										<div class="widget-box">
											...
											<div class="col-sm-10">
												<ul class="pager">
													<li class="previous">
														<a href="${ctx }/admin/bug/${oneBug.bugId -1}">&larr; 上一篇</a>
													</li>

													<li class="next">
														<a href="${ctx }/admin/bug/${oneBug.bugId +1}">下一篇 &rarr;</a>
													</li>
												</ul>
											</div>
										</div>
