	...
	<div class="top_panel">
		<div class="wrapper">
			<div class="user">
				...
				<span class="label"><a href="#">管理员登录</a></span>
			</div>
		</div>
	</div>
	...
	<div class="wrapper contents_wrapper">
		...
		<div class="login">
			...
			<div class="widget_contents lgNoPadding">
				<form action="${ctx }/loginUser/loginAdmin">
				<div class="line_grid">
					<div class="g_2 g_2M"><span class="label">用户名</span></div>
					<div class="g_10 g_10M">
						<input class="simple_field tooltip" title="Your Username" type="text"  name="loginName"></div>
					<div class="clear"></div>
				</div>
				<div class="line_grid">
					<div class="g_2 g_2M"><span class="label">密码</span></div>
					<div class="g_10 g_10M">
						<input class="simple_field tooltip" title="Your Password" type="password"  name="password">
					</div>
					<div class="clear"></div>
				</div>
