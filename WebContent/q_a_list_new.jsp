				...
				<div class="tab-pane fade active in" id="tab2Content1">
					<div class="items items-hover">
						...
						<ul class="pager pager-loose">
							<li class="previous"><a
								href="${ctx}/question/list_new?currentPageNum=${questionPage.prePageNum}&tagName=${tagName}">«</a></li>
							<c:forEach begin="1" end="${questionPage.totalPageNum }"
								var="pageNum">
								<c:if test="${pageNum ==questionPage.currentPageNum }">
								<li class="active"><a
									href="${ctx }/question/list_new?currentPageNum=${pageNum }&tagName=${tagName}">${pageNum }</a></li>
								</c:if>
								<c:if test="${pageNum !=questionPage.currentPageNum }">
								<li><a
									href="${ctx }/question/list_new?currentPageNum=${pageNum }&tagName=${tagName}">${pageNum }</a></li>
							...
							<li class="next"><a
								href="${ctx}/question/list_new?currentPageNum=${questionPage.nextPageNum}&tagName=${tagName}">»</a></li>
						</ul>
					</div>
					<!--标签1内容结束-->
				</div>
