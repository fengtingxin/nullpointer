	...
	<div class="container" style="padding-top: 20px; padding-bottom: 25px;">
		<div style="border: 1px solid #ddd; padding: 20px;">
			...
			<div class="container" style="margin-top: 25px;">
				<a href="${ctx }/question/like?questionId=${question.questionId}&userInfoId=${loginUser.loginUserId}">
				...
				</a><a href="${ctx }/question/hate?questionId=${question.questionId}&userInfoId=${loginUser.loginUserId}">
