		...
		<div class="col-md-3 column">
			...
			<div class="col-md-11 column">
				<div class="example"
					...
					<c:if
						test="${ userInfo.loginUser.userInfo.userInfoDescribe == null || loginUser.userInfo.userInfoDescribe == ''}">
						<p>这家伙很懒 什么都没有留下</p>
					</c:if>
					<p>
				...
				<div class="col-md-12">
					...
					<ul class="nav nav-primary">
						...
						<li><a href="${ctx }/hishome"><i
								class="icon icon-home"></i> Ta的主页</a></li>
						<li class="active"><a href="${ctx }/question/findQuestionByTimeTwo"><i
								class="icon icon-question-sign"></i> Ta的问题</a></li>
						<li><a href="${ctx }/answer/findAnswerByTimeTwo"><i
								class="icon icon-reply"></i> Ta的回答</a></li>
						<li><a href="${ctx }/comment/findCommentByTimeTwo"><i
								class="icon icon-comments"></i> Ta的评论</a></li>
						<li><a href="${ctx }/share/shareByTimeTwo"><i
