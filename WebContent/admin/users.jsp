					...
					<ul class="nav ace-nav">
						...
						<li class="light-blue">
							<a data-toggle="dropdown" href="#" class="dropdown-toggle">
								...
								<!--管理员头像<img class="nav-user-photo" src="assets/avatars/user.jpg" alt="Jason's Photo" />-->
												...
												<c:if test="${not empty allUsers }">
													<c:forEach items="${allUsers }" var="oneUser">
														<tr>
															...
															<td><fmt:formatDate	value="${oneUser.userInfo.userInfoRegistTime}" pattern="yyyy-MM-dd" /></td>
