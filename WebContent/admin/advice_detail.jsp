...
<title>${fn:substring(oneAdvice.adviceTheme, 0, 10)} 
<c:if test="${fn:length(oneAdvice.adviceTheme)>10}">...</c:if></title>
				...
				<div class="main-content">
					<div class="breadcrumbs" id="breadcrumbs">
						...
						<ul class="breadcrumb">
							...
							<li class="active">
								<a href="${ctx }/admin/advice.jsp">用户建议</a>
							</li>
						</ul><!-- .breadcrumb -->
								...
								<div class="row">
									<div class="col-sm-12">
										<div class="widget-box">
											<h4>${oneAdvice.adviceTheme }</h4>
												<address>
													建议人：<strong>${oneAdvice.adviceUserName }</strong>
													发布时间：<strong><fmt:formatDate	value="${oneAdvice.adviceTime}" pattern="yyyy-MM-dd" /></strong>
												</address>
												
											<hr />
											<h1>发现有如下问题：</h1>
											${oneAdvice.adviceContent }
											<hr/>
											<div class="col-sm-10">
												<ul class="pager">
													<li class="previous">
														<a href="${ctx }/admin/advice/${oneAdvice.adviceId -1}">&larr; 上一篇</a>
													</li>

													<li class="next">
														<a href="${ctx }/admin/advice/${oneAdvice.adviceId +1}">下一篇 &rarr;</a>
													</li>
												</ul>
											</div>
										</div>
