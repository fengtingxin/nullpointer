		...
		<div class="navbar-container" id="navbar-container">
			<div class="navbar-header pull-left">
				<a href="#" class="navbar-brand"> <small> 
					<i class="icon-leaf"></i> nullpointer
				</small>
				</a>
				<!-- /.brand -->
			</div>
			...
			<div class="navbar-header pull-right" role="navigation">
				<ul class="nav ace-nav">
					<li class="light-blue"><a data-toggle="dropdown" href="#" class="dropdown-toggle"> <!--管理员头像<img class="nav-user-photo" src="assets/avatars/user.jpg" alt="Jason's Photo" />-->
							<span class="user-info"> <small>欢迎,</small> ${loginUser.loginName }
		...
		<div class="main-container-inner">
			...
			<div class="sidebar" id="sidebar">
				...
				<ul class="nav nav-list">
					...
					<li class="active"><a href="${ctx }/admin/advice.jsp"> <i
							class="icon-text-width"></i> <span class="menu-text"> 用户建议
						</span>
					</a></li>
					<li><a href="#" class="dropdown-toggle"> <i
							class="icon-edit"></i> <span class="menu-text"> bug管理 </span> <b
							class="arrow icon-angle-down"></b>
					</a>

						<ul class="submenu">
							<li><a href="${ctx }/admin/bug"> <i
									class="icon-double-angle-right"></i> 查询bug
							</a></li>

							<li><a href="${ctx }/admin/bug_review"> <i
									class="icon-double-angle-right"></i> bug审核
							</a></li>

							<li><a href="bug_publish"> <i
									class="icon-double-angle-right"></i> 发布bug
							</a></li>
						</ul></li>
					<li><a href="#" class="dropdown-toggle"> <i
						...
						<ul class="submenu">
							<li><a href="${ctx }/admin/users"> <i
									class="icon-double-angle-right"></i> 用户详情
							</a></li>
						</ul></li>
				</ul>
				<!-- /.nav-list -->
			...
			<div class="main-content">
				...
				<div class="page-content">
					...
					<div class="row">
						<div class="col-xs-12">
							<h3 class="header smaller lighter blue">用户建议</h3>
							<div class="table-header">结果来自建议表</div>
							...
							<div class="table-responsive">
								<table id="sample-table-2"
									...
									<tbody>
									<c:if test="${empty allAdvice }">
										<tr>暂无</tr>
									</c:if>
									<c:if test="${not empty allAdvice }">
										<c:forEach items="${allAdvice }" var="oneAdvice">
											<tr>
												<td class="center"><label> <input
														type="checkbox" class="ace" /> <span class="lbl"></span>
												</label></td>
												<td>${oneAdvice.adviceUserName }</td>
												<td>${oneAdvice.adviceUserEmail }</td>
												<td class="hidden-480"><a href="advice/${oneAdvice.adviceId }">
												...
												<td>
													<div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">
														<a class="blue" href="advice/${oneAdvice.adviceId }"> <i
															class="icon-zoom-in bigger-130"></i>
														</a> 
														<a class="red" href="delete?adviceId=${oneAdvice.adviceId }"> <i
													...
													<div class="visible-xs visible-sm hidden-md hidden-lg">
														<div class="inline position-relative">
															...
															<ul	class="dropdown-menu dropdown-only-icon dropdown-yellow pull-right dropdown-caret dropdown-close">
																<li><a href="${oneAdvice.adviceId }" class="tooltip-info"
																	data-rel="tooltip" title="View"> <span class="blue">
																			<i class="icon-zoom-in bigger-120"></i>
																	</span>
																</a></li>
	
																<li><a href="delete?adviceId=${oneAdvice.adviceId }" class="tooltip-error"
		...
		<div class="ace-settings-box" id="ace-settings-box">
			...
			<div>
				<input type="checkbox" class="ace ace-checkbox-2"
					...
					for="ace-settings-add-container"> 中间位置 <b>.包含</b>
				</label>
			</div>
		</div>
	</div>
...
<![endif]-->
	...
	<script type="text/javascript">
		if ("ontouchend" in document)
			document.write("<script src='${ctx }/admin/assets/js/jquery.mobile.custom.min.js'>"
							+ "<"+"/script>");
	</script>
